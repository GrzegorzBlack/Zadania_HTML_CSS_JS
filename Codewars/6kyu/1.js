...
function iqTest(numbers) {
  ...
  let number = [...numbers2].filter((e) => e % 2 == 0);
  //console.log(number);
  let odd = [...numbers2].filter((e) => e % 2 !== 0);
  //console.log(odd);
  let result = number.length > odd.length ? odd : number;

  let index = numbers2.indexOf(result[0]) + 1;
  return index;
}
...
// Inne bardzo ciekawe podejście (nie moje!)
