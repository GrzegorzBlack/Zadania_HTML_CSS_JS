...
// ur times color b, one time color h then one time color a...
...
// number of errors and the denominator the length of the control string. Don't reduce this
...
function printerError(s) {
  ...
  let errors = s.filter((e) => e > "m").length;
  console.log(errors);
...
console.log(printerError("aaabbbbhijjjm"));
